...
public class EnemyMeleeIntro : MonoBehaviour
{
    ...
    [SerializeField] IntroSceneManager introSceneScript;

    Transform target;
    Animator anim;
    Health healthPlayerScript;
    EnemyHealthIntro enemyHealthScript;
    ...
    void Awake()
    {
        ...
        enemyHealthScript = GetComponent<EnemyHealthIntro>();
    ...
    void ReceiveDamage()
    {
        ...
        {
            introSceneScript.ActivateIntro3();
